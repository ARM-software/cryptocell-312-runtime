...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument("-hash_out", default=PRIM_KEY_HASH_FILE_NAME, metavar="FILE",
                                 help="Writes hash result to FILE [default: %(default)s]")
        self.parser.add_argument("-zeros_out", default=ZEROS_NUM_FILES_NAME, metavar="FILE",
